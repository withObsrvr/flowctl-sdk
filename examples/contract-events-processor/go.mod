module github.com/withObsrvr/flowctl-sdk/examples/contract-events-processor
...
require (
	...
	github.com/withObsrvr/flow-proto v0.0.0-20251209215201-bd54ee3e43e9 // indirect
